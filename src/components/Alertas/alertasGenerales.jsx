...
function AlertasGenerales({ refreshKey }) {
  ...
  return (
    <>
      ...
      >
        <p className="text-2xl md:text-3xl font-medium">Alertas generales</p>
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            {alertas.map((alerta) => (
              <motion.div
                key={`${alerta._id}-${alerta.fecha_creacion}`}
...
export default AlertasGenerales;
